...
| Amazon EKS/Lambda       | Compute platform for services                                           | Flexible, containerization (EKS), serverless (Lambda).                                                                               | ECS, EC2 instances, other container orchestration platforms                               |
